<?php
/* --------------------------------------------------------------
   gm_miscellaneous.php 2015-10-09
   Gambio GmbH
   http://www.gambio.de
	...
	<span class="main">
		<table style="margin-bottom:5px" border="0" cellpadding="0" cellspacing="0" width="100%">
		 <tr class="dataTableHeadingRow">
		 	...
		 	<td class="dataTableHeadingContentText" style="width:1%; padding-right:20px; white-space: nowrap">
			    <?php
			        echo ($_GET['content'] !== 'laws') ? '<a href="gm_miscellaneous.php?content=laws">' . TITLE_LAW . '</a>' : TITLE_LAW;
			    ?>
		    </td>
			<td class="dataTableHeadingContentText" style="width:1%; padding-right:20px; white-space: nowrap">
				<?php
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" class="breakpoint-small multi-table-wrapper">
			<tr class="gx-container">
				...
				<!-- LAW AND ORDER -->
					...
					<table class="gx-configuration gx-configuration-table" border="0" width="100%" cellspacing="0" cellpadding="2">
						<tr>
                    ...
                    <table class="gx-configuration gx-configuration-table" border="0" width="100%" cellspacing="0" cellpadding="2">
						...
						<tr>
							...
							<td class="dataTableContent_gm">
								<input type="text" name="GM_WITHDRAWAL_CONTENT_ID" value="<?php echo gm_get_conf('GM_WITHDRAWAL_CONTENT_ID'); ?>" />
							</td>
						</tr>
						<tr>
                            <td class="dataTableContent_gm configuration-label">
							...
							<td class="dataTableContent_gm">
                                <div class="gx-container" data-gx-widget="checkbox">
								    <input type="checkbox" name="WITHDRAWAL_WEBFORM_ACTIVE" value="1"<?php if(gm_get_conf('WITHDRAWAL_WEBFORM_ACTIVE') == '1') echo ' checked="checked"'; ?>/>
                                </div>
							</td>
						</tr>
						<tr>
							...
							<td class="dataTableContent_gm">
                                <div class="gx-container" data-gx-widget="checkbox">
                                    <input type="checkbox" name="WITHDRAWAL_PDF_ACTIVE" value="1"<?php if(gm_get_conf('WITHDRAWAL_PDF_ACTIVE') == '1') echo ' checked="checked"'; ?>/>
                                </div>
							</td>
						</tr>
						<tr>
							...
							<td class="dataTableContent_gm">
                                <div class="gx-container" data-gx-widget="checkbox">
                                    <input type="checkbox" id="show_account_withdrawal_link" name="SHOW_ACCOUNT_WITHDRAWAL_LINK" value="1" <?php echo (gm_get_conf('SHOW_ACCOUNT_WITHDRAWAL_LINK') == 1) ? 'checked="checked"' : ''; ?> />
                                </div>
							</td>
						</tr>
						<tr>
							...
							<td class="dataTableContent_gm">
                                <div class="gx-container" data-gx-widget="checkbox">
                                    <input type="checkbox" id="attach_conditions_of_use_in_order_confirmation" name="ATTACH_CONDITIONS_OF_USE_IN_ORDER_CONFIRMATION" value="1" <?php echo (gm_get_conf('ATTACH_CONDITIONS_OF_USE_IN_ORDER_CONFIRMATION') == 1) ? 'checked="checked"' : ''; ?> />
                                </div>
							</td>
						</tr>
						<tr>
							...
							<td class="dataTableContent_gm">
                                <div class="gx-container" data-gx-widget="checkbox">
                                    <input type="checkbox" id="attach_withdrawal_info_in_order_confirmation" name="ATTACH_WITHDRAWAL_INFO_IN_ORDER_CONFIRMATION" value="1" <?php echo (gm_get_conf('ATTACH_WITHDRAWAL_INFO_IN_ORDER_CONFIRMATION') == 1) ? 'checked="checked"' : ''; ?> />
                                </div>
							</td>
						</tr>
						<tr>
							...
							<td class="dataTableContent_gm">
                                <div class="gx-container" data-gx-widget="checkbox">
                                    <input type="checkbox" id="attach_withdrawal_form_in_order_confirmation" name="ATTACH_WITHDRAWAL_FORM_IN_ORDER_CONFIRMATION" value="1" <?php echo (gm_get_conf('ATTACH_WITHDRAWAL_FORM_IN_ORDER_CONFIRMATION') == 1) ? 'checked="checked"' : ''; ?> />
                                </div>
							</td>
						</tr>
                        <?php
                        ...
                        <tr class="download_delay_configuration_wrapper">
                            ...
                            <td class="dataTableContent_gm withdrawal_time_wrapper">
                                <input type="text" id="DOWNLOAD_DELAY_FOR_ABANDONMENT_OF_WITHDRAWL_RIGHT_DAYS" name="DOWNLOAD_DELAY_FOR_ABANDONMENT_OF_WITHDRAWL_RIGHT_DAYS" value="<?php echo($coo_download_delay_abandomment->get_delay_days());?>"  /> :
                                <input type="text" id="DOWNLOAD_DELAY_FOR_ABANDONMENT_OF_WITHDRAWL_RIGHT_HOURS" name="DOWNLOAD_DELAY_FOR_ABANDONMENT_OF_WITHDRAWL_RIGHT_HOURS" value="<?php echo($coo_download_delay_abandomment->get_delay_hours());?>"  /> :
                                <input type="text" id="DOWNLOAD_DELAY_FOR_ABANDONMENT_OF_WITHDRAWL_RIGHT_MINUTES" name="DOWNLOAD_DELAY_FOR_ABANDONMENT_OF_WITHDRAWL_RIGHT_MINUTES" value="<?php echo($coo_download_delay_abandomment->get_delay_minutes());?>"  /> :
                                <input type="text" id="DOWNLOAD_DELAY_FOR_ABANDONMENT_OF_WITHDRAWL_RIGHT_SECONDS" name="DOWNLOAD_DELAY_FOR_ABANDONMENT_OF_WITHDRAWL_RIGHT_SECONDS" value="<?php echo($coo_download_delay_abandomment->get_delay_seconds());?>"  />
                        ...
                        <tr>
                            ...
                            <td class="dataTableContent_gm withdrawal_time_wrapper">
                                <input type="text" id="DOWNLOAD_DELAY_WITHOUT_ABANDONMENT_OF_WITHDRAWL_RIGHT_DAYS" name="DOWNLOAD_DELAY_WITHOUT_ABANDONMENT_OF_WITHDRAWL_RIGHT_DAYS" value="<?php echo($coo_download_delay_without_abandomment->get_delay_days());?>"  /> :
                                <input type="text" id="DOWNLOAD_DELAY_WITHOUT_ABANDONMENT_OF_WITHDRAWL_RIGHT_HOURS" name="DOWNLOAD_DELAY_WITHOUT_ABANDONMENT_OF_WITHDRAWL_RIGHT_HOURS" value="<?php echo($coo_download_delay_without_abandomment->get_delay_hours());?>"  /> :
                                <input type="text" id="DOWNLOAD_DELAY_WITHOUT_ABANDONMENT_OF_WITHDRAWL_RIGHT_MINUTES" name="DOWNLOAD_DELAY_WITHOUT_ABANDONMENT_OF_WITHDRAWL_RIGHT_MINUTES" value="<?php echo($coo_download_delay_without_abandomment->get_delay_minutes());?>"  /> :
                                <input class="smallText" type="text" id="DOWNLOAD_DELAY_WITHOUT_ABANDONMENT_OF_WITHDRAWL_RIGHT_SECONDS" name="DOWNLOAD_DELAY_WITHOUT_ABANDONMENT_OF_WITHDRAWL_RIGHT_SECONDS" value="<?php echo($coo_download_delay_without_abandomment->get_delay_seconds());?>"  />
                                <span data-gx-widget="tooltip_icon" data-tooltip_icon-type="info">
									<?php echo(DESCIPTION_DOWNLOAD_DELAY_WITHOUT_ABANDONMENT_OF_WITHDRAWL_RIGHT);?>
								</span>
                            </td>
						...
						<tr>
							...
							<td class="dataTableContent_gm">
								<div class="gx-container" data-gx-widget="checkbox">
									<input type="checkbox" name="CHECK_ABANDONMENT_OF_WITHDRAWL_DOWNLOAD" value="1" <?php echo (gm_get_conf('CHECK_ABANDONMENT_OF_WITHDRAWL_DOWNLOAD') == 1) ? 'checked="checked"' : ''; ?> />
								</div>
							</td>
						</tr>
						<tr>
							...
							<td class="dataTableContent_gm">
								<div class="gx-container" data-gx-widget="checkbox">
									<input type="checkbox" name="CHECK_ABANDONMENT_OF_WITHDRAWL_SERVICE" value="1" <?php echo (gm_get_conf('CHECK_ABANDONMENT_OF_WITHDRAWL_SERVICE') == 1) ? 'checked="checked"' : ''; ?> />
								</div>
							</td>
						</tr>
					</table>
