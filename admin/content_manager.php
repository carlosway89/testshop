<?php
/* --------------------------------------------------------------
   content_manager.php 2015-09-28 gm
   Gambio GmbH
   http://www.gambio.de
...
$userId                   = MainFactory::create('Id', (int)$_SESSION['customer_id']);
	...
	<!-- body_text //-->
		...
		<tr>
			<td>
				...
				<table class="main gx-configuration shop-content-overview<?php if(isset($_GET['show']) && $_GET['show'] === 'product_content' && !$_GET['action']){ echo ' hidden'; } ?>" width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
	...
	<table class="content_manager" border="0" width="100%" cellspacing="0" cellpadding="2">
				  <tr class="dataTableHeadingRow">
					...
					<td class="dataTableHeadingContent" align="left"><?php echo TABLE_HEADING_CONTENT_GROUP; ?></td>
					<td class="dataTableHeadingContent" align="left"><?php echo TABLE_HEADING_CONTENT_SORT; ?></td>
					<td class="dataTableHeadingContent" align="left"><?php echo TABLE_HEADING_CONTENT_FILE; ?></td>
					<td class="dataTableHeadingContent" nowrap align="left"><?php echo TABLE_HEADING_CONTENT_STATUS; ?></td>
					<td class="dataTableHeadingContent" nowrap align="left"><?php echo TABLE_HEADING_CONTENT_BOX; ?></td>
	...
	$t_download_files_array = array();
	 ...
	 if ($dir= opendir(DIR_FS_CATALOG.'media/content/'))
	 {
	 	...
	 	while(($file = readdir($dir)) !==false)
		{
			...
			if(is_file( DIR_FS_CATALOG.'media/content/'.$file) and ($file !="index.html") && $file !=".htaccess")
			{
				$t_content_files_array[]=array(
								'id' => $file,
								'text' => $file);
...
?>
		...
		?>
		<tr>
			<td width="15%" valign="top"><?php echo WITHDRAWAL_FORM_FILE_LABEL; ?>:</td>
			<td width="85%">
				<?php
...
<!--	$gm_url_keywords = xtc_db_prepare_input($categories_data['gm_url_keywords'][$lang['id']]);
	...
	<div class="add-margin-top-24" data-gx-compatibility="content_manager/content_manager_controller" data-gx-widget="button_dropdown">
    ...
    <div class="product-content-overview<?php if(!isset($_GET['show']) || $_GET['show'] !== 'product_content'){ echo ' hidden'; } ?>">
	 <?php
	 if (!$_GET['action']) {
	 // products content
	 ...
	 <table class="content_manager" border="0" width="100%" cellspacing="0" cellpadding="2">
		<tr class="dataTableHeadingRow">
		 <td class="dataTableHeadingContent" nowrap width="1%" ><?php echo TABLE_HEADING_PRODUCTS_ID; ?></td>
		 <td class="dataTableHeadingContent" width="99%" align="left"><?php echo TABLE_HEADING_PRODUCTS; ?></td>
	</tr>
	<?php
			 ...
			 ?>
					 <table border="0" width="100%" cellspacing="0" cellpadding="2">
						 ...
						 <?php
							 ...
							 echo '<tr class="dataTableRow visibility_switcher" onmouseover="this.className=\'dataTableRowOver\'" onmouseout="this.className=\'dataTableRow\'">' . "\n";
