...
class LayoutContentView extends ContentView
{
	...
	public function prepare_data()
	{
		...
		$this->content_array['header_content_html'] = $this->get_header_content_html();
	}
	...
	public function get_header_content_html()
	{
		$t_header_html = array();
		...
		{
			$t_header_html = xtc_db_fetch_array($t_content_query);
		}
		return $t_header_html;
	}
