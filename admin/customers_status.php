<?php
/* --------------------------------------------------------------
   customers_status.php 2015-09-28 gm
   Gambio GmbH
   http://www.gambio.de
...
<div class="hidden">
  ...
  switch ($_GET['action']) {
    ...
    case 'edit':
      ...
      $contents[] = array('text' => '<span class="options-title">' . TEXT_INFO_CUSTOMERS_STATUS_NAME . '</span>' . $customers_status_inputs_string);
      $contents[] = array('text' => '' . xtc_image(DIR_WS_ICONS . $cInfo->customers_status_image, htmlspecialchars($cInfo->customers_status_name, ENT_QUOTES)) . '<br />' . DIR_WS_ICONS . '<br /><b>' . $cInfo->customers_status_image . '</b>');
