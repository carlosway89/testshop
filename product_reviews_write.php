...
$GLOBALS['breadcrumb']->add(NAVBAR_TITLE_REVIEWS_WRITE, xtc_href_link(FILENAME_PRODUCT_REVIEWS, $get_params));
...
$coo_product_reviews_write_control->proceed($product, $t_customer_id);
