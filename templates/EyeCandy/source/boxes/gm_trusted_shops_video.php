<?php
/* --------------------------------------------------------------
   gm_trusted_shops_video.php 2014-07-17 gambio
   Gambio GmbH
   http://www.gambio.de
...
$coo_trusted_video = MainFactory::create_object('TrustedVideoBoxContentView');
$t_box_html = $coo_trusted_video->get_html();

$gm_box_pos = $GLOBALS['coo_template_control']->get_menubox_position('gm_trusted_shops_video');
