...
if(gm_get_conf('SHOW_FOOTER') != 'true') $this->set_content_data('COPYRIGHT_FOOTER', gm_get_conf('GM_FOOTER'));
...
if($GLOBALS['coo_template_control']->get_menubox_status('gm_trusted_shops_video')) include(DIR_WS_BOXES.'gm_trusted_shops_video.php');
