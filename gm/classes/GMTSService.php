	...
	public function getRichSnippet($tsid) {
		...
		if(is_object($snippet_data))
		{
			...
			if($reviewsFound) {
				...
				$snippet .= '<a href="http://www.trustedshops.eu/customer-review/" target="_blank">Trusted Shops customer reviews</a>:'.
					'<span xmlns:v="http://rdf.data-vocabulary.org/#" typeof="v:Review-aggregate">'.
					'  <span rel="v:rating"><span property="v:value">'.$result.'</span>'.
					'</span> / <span property="v:best">'.$max.'</span> of <span property="v:votes">'.$count.'</span> '.
					'<a href="https://www.trustedshops.com/buyerrating/info_'.$tsid.'.html" title="'.$shopName.' custom reviews" target="_blank">'.
					$shopName .' reviews</a></span>';
				$snippet .= '</div>';
