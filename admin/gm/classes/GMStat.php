...
class GMStat_ORIGIN
{
	...
	{
		if(file_exists(DIR_FS_ADMIN . 'images/graphs/gm_graph.png'))
		{
			@unlink(DIR_FS_ADMIN . 'images/graphs/gm_graph.png');
		}
	...
	function update()
	{
		...
		if($_GET['action'] == 'gm_counter_conf')
		{
			...
			include(DIR_FS_ADMIN . 'gm/gm_counter/gm_counter_conf.php');
		}
