<?php
/* --------------------------------------------------------------
   GoogleRichSnippetContentView.inc.php 2015-07-28 gm
   Gambio GmbH
   http://www.gambio.de
...
class GoogleRichSnippetContentView extends ContentView
{
	...
	public function get_review_snippet()
	{
		...
		$t_rich_snippet_array['rating_itemprop_worstRating'] = '';
		$t_rich_snippet_array['rating_itemprop_ratingValue'] = '';
		$t_rich_snippet_array['rating_itemprop_bestRating'] = '';
		...
		if(empty($t_uninitialized_array))
		{
			...
			{   
				...
				$t_rich_snippet_array['review_itemprop_itemReviewed'] = ' itemprop="itemReviewed" itemscope itemtype="http://schema.org/Product"';
				...
				$t_rich_snippet_array['rating_itemprop_worstRating'] = '<meta itemprop="worstRating" content="1">';
				$t_rich_snippet_array['rating_itemprop_ratingValue'] = '<meta itemprop="ratingValue" content="' . $this->rating . '">';
				$t_rich_snippet_array['rating_itemprop_bestRating'] = '<meta itemprop="bestRating" content="5">';
			}
		}
		else
		{
