...
define('DESCRIPTION_FORCE_VERSION_SELECTION', 'Wenn der Update-Vorgang nach der Installation abgebrochen wurde oder fehlgeschlagen ist, kann mit dieser Option die aktuelle Shopversion ausgewählt werden, um das Update erneut ausführen zu können.');
...
define('TEXT_NOT_ALL_SE_V2_FILES_UPLOADED', 'Das StyleEdit Module wurde nicht vollständig hochgeladen. Bitte laden Sie das gesamte StyleEdit Verzeichnis noch einmal auf Ihren Webserver');
