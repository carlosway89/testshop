...
define('SHOPGATE_CONFIG_EXPORT_OPTIONS_AS_INPUT_FIELD_DESCRIPTION', 'F&uuml;gen Sie die id (Kann unter "Artikelmerkmale" gefunden werden) der option(en), welche als Textfeld exportiert werden soll(en), der Textfl&auml;che hinzu.(Beispiel: 1,2,3). Wichtig: Am Ende darf kein Komma stehen');
