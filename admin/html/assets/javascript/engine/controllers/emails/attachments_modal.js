	...
	function (data) {
		...
		var _onDeleteOldAttachments = function (event) {
			...
			jse.libs.modal.message({
				                       title: jse.core.lang.translate('delete', 'buttons') + ' - ' + Date.parse($this.find('#removal-date')
					                                                                                                .datepicker(
				                       ...
				                       buttons: [
					                       ...
					                       },
					                       {
						                       ...
						                       click: function () {
							                       jse.libs.emails.deleteOldAttachments($('#removal-date').datepicker('getDate'))
								                       .done(function (response) {
									                       ...
									                       jse.libs.modal.message({
										                                              title: 'Info',
										                                              content: jse.core.lang.translate('message_delete_old_attachments_success',
										                                                                               'emails') + '<br/>'
										                                                       + jse.core.lang.translate('count', 'admin_labels') + ': '
										                                                       + response.count + ', '
										                                                       + jse.core.lang.translate('size', 'db_backup') + ': ' + size
									                                              });
