...
CREATE TABLE `products` (
  ...
  `products_weight` decimal(15,4) NOT NULL default '0.00',
  ...
  `products_image_w` int(11) NOT NULL,
  `products_image_h` int(11) NOT NULL,
