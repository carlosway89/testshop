 ...
 *
 * @module Controllers/order_tooltip
 */
gx.controllers.module(
	...
	/**  @lends module:Controllers/order_tooltip */
			...
			if (options.url !== '') {
				$.ajax({
					       ...
					       success: function (response) {
						       ...
						       content += '<tr><td class="total_price" colspan="4" align="right">' + response.total_price +
						                  '</td></tr>';
