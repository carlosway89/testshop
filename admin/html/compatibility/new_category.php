...
$gmAlt                    = new GMAltText();
$categoryImageSize        = ($cInfo->categories_image) ? getimagesize(DIR_FS_CATALOG . 'images/categories/'
                                                                      . $cInfo->categories_image) : null;
$categoryIconSize         = ($cInfo->categories_icon) ? @getimagesize(DIR_FS_CATALOG . 'images/categories/icons/'
                                                                      . $cInfo->categories_icon) : null;
...
if(count($categoryOverviewTplFiles) > 0)
{
	...
	$categoryOverviewTplDefaultValue   = $cInfo->categories_template;
...
if(count($articleOverviewTplFiles) > 0)
{
	...
	$articleOverviewTplDefaultValue   = $cInfo->listing_template;
...
{
	$productSortOrderDefaultValue = $cInfo->products_sorting;
}
/**
 * #####################################################################################################################
...
$categoryFilterChecked = ($cInfo->show_category_filter === '1') ? ' checked="checked"' : '';
 ...
 * #####################################################################################################################
 */
$text_new_or_edit = TEXT_INFO_HEADING_EDIT_CATEGORY . ': ' . xtc_get_categories_name($cInfo->categories_id,
...
echo xtc_draw_form('new_category', FILENAME_CATEGORIES, implode('&', $t_form_action_array), 'post',
...
<div class="gx-container gx-category-details breakpoint-large">
	<div class="grid">
		<?php echo xtc_draw_hidden_field('categories_date_added',
				(($cInfo->date_added) ? $cInfo->date_added : date('Y-m-d'))) . xtc_draw_hidden_field('parent_id',
		                                                                                             $cInfo->parent_id); ?>
			...
			<div class="span6">
				<div class="grid control-group">
					...
					<div class="span6" data-gx-widget="checkbox">
						<?php echo xtc_draw_selection_field('status', 'checkbox', '1',
						                                    $cInfo->categories_status == 1 ? true : false); ?>
					</div>
				</div>
				<div class="grid control-group">
					<div class="span6">
					...
					<div class="span6">
						<?php echo xtc_draw_pull_down_menu('categories_template', $categoryOverviewTplFiles,
				...
				<div class="grid control-group">
					...
					<div class="span6">
						<?php echo xtc_draw_pull_down_menu('listing_template', $articleOverviewTplFiles,
				...
				<div class="grid control-group">
					...
					<div class="span6">
						<?php echo xtc_draw_pull_down_menu('products_sorting', $productsSortOrderArray,
				...
				<div class="grid control-group">
					...
					<div class="span6">
						<?php echo xtc_draw_pull_down_menu('products_sorting2', array(
							array('id' => 'ASC', 'text' => GM_SORT_ASC),
							array('id' => 'DESC', 'text' => GM_SORT_DESC)
						), $cInfo->products_sorting2) ?>
					</div>
				</div>
				<div class="grid control-group">
					<div class="span6">
				...
				<div class="grid control-group">
					...
					<div class="span6">
						<?php echo xtc_draw_pull_down_menu('gm_priority', $siteMapPriorityArray,
						                                   $cInfo->gm_priority); ?>
					</div>
				</div>
				<div class="grid control-group">
					...
					<div class="span6">
						<?php echo xtc_draw_pull_down_menu('gm_changefreq', $siteMapChangeFreqArray,
						                                   $cInfo->gm_changefreq); ?>
					</div>
				</div>
				<div class="grid control-group">
				...
				<div class="grid control-group remove-border">
					...
					<div class="span6" data-gx-widget="checkbox">
						<?php
						if($cInfo->gm_gprint_subcategories == '1')
						{
							echo xtc_draw_checkbox_field('gm_gprint_subcategories', '1', true);
						}
						else
						{
				...
				<div class="grid control-group">
					...
					<div class="span6" data-gx-widget="checkbox">
						<?php
						if($cInfo->gm_gprint_delete_assignment == '1')
						{
				...
				<div class="grid control-group">
					...
					<div class="span6" data-gx-widget="checkbox">
						<?php echo xtc_draw_selection_field('gm_show_qty_info', 'checkbox', '1',
						                                    $cInfo->gm_show_qty_info == 1 ? true : false); ?>
					</div>
				</div>
				<div class="grid control-group">
					<div class="span6">
					...
					<div class="span6" data-gx-widget="checkbox">
						<?php echo xtc_draw_selection_field('gm_show_attributes', 'checkbox', '1',
						                                    $cInfo->gm_show_attributes == 1 ? true : false); ?>
					</div>
				</div>
				<div class="grid control-group">
					<div class="span6">
					...
					<div class="span6" data-gx-widget="checkbox">
						<?php echo xtc_draw_selection_field('gm_show_graduated_prices', 'checkbox', '1',
						                                    $cInfo->gm_show_graduated_prices == 1 ? true : false); ?>
					</div>
				</div>
				<div class="grid control-group">
					<div class="span6">
					...
					<div class="span6" data-gx-widget="checkbox">
						<?php echo xtc_draw_selection_field('gm_show_qty', 'checkbox', '1',
						                                    $cInfo->gm_show_qty == 1 ? true : false); ?>
					</div>
				</div>
				<div class="grid control-group">
					<div class="span6">
				...
				<div class="span6">
					...
					<?php if(count($featureArray) > 0): ?>
						<div class="grid control-group">
							...
							<div class="span6" data-gx-widget="checkbox">
								<select>
									<option value="0"><?php echo TEXT_FEATURE_MODE_STANDARD; ?></option>
									<option value="1"><?php echo TEXT_FEATURE_MODE_STEPS; ?></option>
								</select>
							</div>
						</div>
						<div class="grid control-group remove-border">
							...
							<div class="span6" data-gx-widget="checkbox">
								<select>
									<option value="0"><?php echo TEXT_FEATURE_DISPLAY_MODE_HIDE; ?></option>
									<option value="1"><?php echo TEXT_FEATURE_DISPLAY_MODE_DISABLE; ?></option>
								</select>
							</div>
						</div>
						<br />
						...
						<div class="grid">
							<table class="feature-table gx-modules-table">
								<thead>
									<tr class="dataTableHeadingRow">
										<td class="dataTableHeadingContent"><?php echo TEXT_NAME . '(' . TEXT_INTERNAL_NAME . ')'; ?></td>
							...
							<div class="span12 add-feature-container">
								...
								<input type="submit" name="insert_feature" value="<?php echo BUTTON_ADD; ?>" class="btn">
							</div>
						</div>
					<?php else: ?>
						<div class="grid control-group">
		...
		<div class="frame-wrapper default">
			<div class="frame-head"
			     ...
			     data-collapser-collapsed="<?php echo $userConfigurationService->getUserConfiguration($userId,
			                                                                                          ...
			                                                                                          . '_collapse'); ?>">
				<label>
					<?php echo xtc_image(DIR_WS_LANGUAGES . $language['directory'] . '/admin/images/'
					...
					<div class="control-group">
						<div class="span12 category-name-container category-details">
							...
							<?php echo xtc_draw_input_field('categories_name[' . $language['id'] . ']',
								(($categories_name[$language['id']]) ? stripslashes($categories_name[$language['id']]) : xtc_get_categories_name($cInfo->categories_id,
								                                                                                                                 $language['id']))) ?>
						</div>
					</div>
					<div class="control-group">
						<div class="span12 category-details">
							...
							<?php echo xtc_draw_input_field('categories_heading_title[' . $language['id'] . ']',
								(($categories_name[$language['id']]) ? stripslashes($categories_name[$language['id']]) : xtc_get_categories_heading_title($cInfo->categories_id,
								                                                                                                                          $language['id']))) ?>
						</div>
					</div>
					<div class="control-group">
						<div class="span12 ckeditor-container category-details">
							...
							<div
								...
								<textarea name="<?php echo 'categories_description[' . $language['id'] . ']'; ?>"
								          class="wysiwyg">
									<?php
									echo (($categories_description[$language['id']]) ? stripslashes($categories_description[$language['id']]) : xtc_get_categories_description($cInfo->categories_id, $language['id']));
									?>
								</textarea>
							</div>
						</div>
					...
					<div class="grid control-group first-meta-data-item">
						...
						<div class="span6" data-gx-widget="checkbox">
							<?php echo xtc_draw_input_field('categories_meta_title[' . $language['id'] . ']',
								(($categories_meta_title[$language['id']]) ? stripslashes($categories_meta_title[$language['id']]) : xtc_get_categories_meta_title($cInfo->categories_id,
								                                                                                                                                   $language['id']))); ?>
						</div>
					</div>
					<div class="grid control-group remove-border">
						...
						<div class="span6" data-gx-widget="checkbox">
							<?php echo xtc_draw_input_field('categories_meta_description[' . $language['id'] . ']',
								(($categories_meta_description[$language['id']]) ? stripslashes($categories_meta_description[$language['id']]) : xtc_get_categories_meta_description($cInfo->categories_id,
								                                                                                                                                                     $language['id']))); ?>
						</div>
					</div>
				</div>
					...
					<div class="grid control-group first-meta-data-item">
						...
						<div class="span6" data-gx-widget="checkbox">
							<?php echo xtc_draw_input_field('categories_meta_keywords[' . $language['id'] . ']',
								(($categories_meta_keywords[$language['id']]) ? stripslashes($categories_meta_keywords[$language['id']]) : xtc_get_categories_meta_keywords($cInfo->categories_id,
								                                                                                                                                            $language['id']))); ?>
						</div>
					</div>
					<div class="grid control-group remove-border">
						...
						<div class="span6" data-gx-widget="checkbox">
							<?php echo xtc_draw_input_field('gm_url_keywords[' . $language['id'] . ']',
								(($gm_url_keywords[$language['id']]) ? stripslashes($gm_url_keywords[$language['id']]) : gm_get_categories_url_keywords($cInfo->categories_id,
								                                                                                                                        $language['id']))); ?>
						</div>
					</div>
				</div>
	...
	<?php if (GROUP_CHECK == 'true'): ?>
		<div class="frame-wrapper default customer-groups">
			...
			<div class="frame-content grid" data-gx-widget="checkbox">
				...
				{
					$checked = ($category['group_permission_'.$customers_statuses_array[$i]['id']]) ? 'checked' : '';
					$singleCheckbox = ($customers_statuses_array[$i]['id'] === 'all') ? ' data-single_checkbox' : '';
					echo '
						<div class="span12">
					...
					<div class="span6">
						<?php if($cInfo->categories_icon): ?>
							...
							<img style="float:left;"
							     class="img-thumbnail"
							     src="<?php echo DIR_WS_CATALOG . 'images/categories/icons/'
							                     . $cInfo->categories_icon; ?>" <?php echo $categoryIconSize[3]; ?>>
							<?php
						endif;
						echo xtc_draw_file_field('categories_icon') . xtc_draw_hidden_field('categories_previous_icon',
						                                                                    $cInfo->categories_icon);
						?>
					</div>
				</div>
				<div class="grid control-group remove-border">
				...
				<div class="grid control-group remove-border">
					...
					<div class="span6">
						<?php if($cInfo->categories_image): ?>
							...
							<img style="float:left;"
							     ...
							     src="<?php echo DIR_WS_CATALOG . 'images/categories/'
							                     . $cInfo->categories_image; ?>" <?php echo $categoryImageSize[3]; ?>>
							<?php
						...
						echo xtc_draw_file_field('categories_image')
						     . xtc_draw_hidden_field('categories_previous_image', $cInfo->categories_image);
						?>
					</div>
				</div>
				<div class="grid control-group remove-border">
					...
					<div class="grid control-group remove-border">
						...
						<div class="span5">
							...
							echo xtc_draw_input_field('gm_categories_image_alt_text_' . $language['id'],
							                          $gmAlt->get_cat_alt($_GET['cID'], $language['id']));
							?>
						</div>
						<div class="span1">
							<?php echo xtc_image(DIR_WS_LANGUAGES . $language['directory'] . '/admin/images/'
