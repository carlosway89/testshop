<?php
/* --------------------------------------------------------------
   gm_gprint_configuration.inc.php 2015-09-17 gm
   Gambio GmbH
   http://www.gambio.de
						...
						<tr>
							...
							<td>
								<select name="gm_gprint_position" id="gm_gprint_position">
									<option value="1"><?php echo ucfirst(GM_GPRINT_POSITION_1_TEXT); ?></option>
									<option value="2"><?php echo ucfirst(GM_GPRINT_POSITION_2_TEXT); ?></option>
									<option value="3"><?php echo ucfirst(GM_GPRINT_POSITION_2_TEXT); ?></option>
								</select>	
							</td>
						</tr>
