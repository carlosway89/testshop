<?php
/* --------------------------------------------------------------
   function.object_product_list.php 2014-05-09 gambio
   Gambio GmbH
   http://www.gambio.de
...
function smarty_function_load_language_text($params, &$smarty)
{
	...
	$coo_text_mgr = MainFactory::create_object('LanguageTextManager', array($t_section, $t_language_id, $t_use_fallback), false);
