...
class CheckoutShippingContentView extends ContentView
{
	...
	{
		/* @var GMIntraship $intraship */
		$intraship = MainFactory::create_object('GMIntraship');
		
		if($intraship->isPostfinderActive() && $intraship->isPackstationAddress($this->address_book_id) == false)
		{
