...
function generateSliderImageList()
{
	...
	foreach ($slider_image_array as $t_key => $t_coo_image) {
		...
		$t_img_edit = '';
		if(file_exists(DIR_FS_CATALOG . 'images/slider_images/' . $t_img_file) && is_file(DIR_FS_CATALOG . 'images/slider_images/' . $t_img_file))
		{
		...
		$t_thumb_edit = '';
		if(file_exists(DIR_FS_CATALOG . 'images/slider_images/thumbnails/' . $t_img_thumb) && is_file(DIR_FS_CATALOG . 'images/slider_images/thumbnails/' . $t_img_thumb))
		{
