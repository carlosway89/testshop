<?php
/* --------------------------------------------------------------
  FilterBoxContentView.inc.php 2014-11-11 gm
  Gambio GmbH
  http://www.gambio.de
...
class FilterBoxContentView extends ContentView
{
	...
	public function prepare_data()
	{
		...
		if($this->gmSEOBoost->boost_categories == true)
		{
			# use boosted url
		...
		else
		{
			...
			$t_all_get_params = xtc_get_all_get_params();
			$t_action_url = basename($_SERVER['PHP_SELF']) . '?' . trim(urldecode($t_all_get_params), '&');
		}
