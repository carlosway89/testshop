...
<html <?php print HTML_PARAMS; ?>>
	<head>
		...
		<style>
			...
			form table tr td input{ width: 305px; }
			form table tr td select{ width: 309px; }
			form table tr td h2{ background-color: #3E5E87; color: #fff; padding: 3px 0 3px 10px; margin: 10px 0; text-transform: uppercase; }
			form table tr td.close{ background-color: #3E5E87; color: #fff; padding: 1px 5px;}
						...
						<tr>
							<td>
								<table border="0" width="100%" cellspacing="0" cellpadding="0">
									<tr><td class="pageHeading" style="padding-left: 0px" colspan="2"><?php print HGW_CONFIG_TITLE; ?></td></tr>
									<tr>
											...
											<form action="<?php print PAGE_URL; ?>" method="POST">
												<table>
													...
													<tr><td><?php print HGW_BOOKING_MODE_CC;?></td>
														...
														<td class="small" rowspan='4'><?php print HGW_BOOKING_MODE_INFO; ?></td>
													</tr>
