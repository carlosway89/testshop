...
*/
	...
	protected function _setButtonEditProductUrl()
	{
		...
		{
			$this->set_content_data('BUTTON_EDIT_PRODUCT_URL', xtc_href_link_admin(FILENAME_EDIT_PRODUCTS, 'cPath=' . $this->cPath . '&pID=' . xtc_get_prid($this->product->data['products_id']) . '&action=new_product', 'NONSSL'));
		}
	}
