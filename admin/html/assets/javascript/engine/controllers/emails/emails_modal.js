	...
	function (data) {
		...
		var _onDeleteAttachment = function (event) {
			var row = $(this).parents('tr').get(0),
				url = jse.core.config.get('shopUrl') + '/admin/admin.php?do=Emails/DeleteAttachment',
				data = {
		...
		var _onDownloadAttachment = function (event) {
			...
			var row = $(this).parents('tr').get(0),
				...
				url = jse.core.config.get('shopUrl') + '/admin/admin.php?do=Emails/DownloadAttachment&path=' + path;
