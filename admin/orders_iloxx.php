<?php 
/* --------------------------------------------------------------
   orders_iloxx.php 2015-09-28 gm
   Gambio GmbH
   http://www.gambio.de
...
<html <?php echo HTML_PARAMS; ?>>
	...
	<body>
		...
		<script type="text/javascript">
		  var shipDate = new ctlSpiffyCalendarBox("shipDate", "iloxx_orders", "shipdate","btnDate1","<?php echo date('Y-m-d'); ?>",scBTNMODE_CUSTOMBLUE);
		</script>
		<!-- header //-->
						...
						<tr>
							<td class="main">
								...
								<form action="<?php echo PAGE_URL ?>" method="POST" name="iloxx_orders">
									...
									<script type="text/javascript">shipDate.writeControl(); shipDate.dateFormat="yyyy-MM-dd";</script>
									<br>
