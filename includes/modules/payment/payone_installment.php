<?php
/* --------------------------------------------------------------
	payone_installment.php 2014-07-15 mabr
	Gambio GmbH
	http://www.gambio.de
...
class payone_installment_ORIGIN extends payone_master {
	...
	function payment_action() {
		...
		$personal_data->setStreet($GLOBALS['order']->billing['street_address']);
		...
		$delivery_data->setShippingStreet($GLOBALS['order']->delivery['street_address']);
