<?php
/* --------------------------------------------------------------
   EmailsController.inc.php 2015-12-03 gm
   Gambio GmbH
   http://www.gambio.de
...
class EmailsController extends AdminHttpViewController
{
	...
	{
		if(file_exists(DIR_FS_ADMIN . 'html/content/emails.html') == false)
		{
	...
	public function actionDefault()
	{
		...
		{
			// CSRF Protection
			throw new Exception('Page Token Generator not found.');
		}
		...
		return new AdminPageHttpControllerResponse($title, $html, null, $JavaScriptEngineLanguages);
	}
