<?php
/* --------------------------------------------------------------
  HeaderContentView.inc.php 2015-10-23 gm
  Gambio GmbH
  http://www.gambio.de
	...
	public function get_warnings_html()
	{
		...
		if(WARN_INSTALL_EXISTENCE == 'true')
		{
			if(file_exists(dirname($_SERVER['SCRIPT_FILENAME']) . '/gambio_installer'))
			{
				...
				{
					xtc_output_warning(sprintf(WARNING_INSTALL_DIRECTORY_EXISTS, dirname($_SERVER['SCRIPT_FILENAME'])));
				}
			}
		}
		...
		if(WARN_CONFIG_WRITEABLE == 'true')
		{
			...
			{
				xtc_output_warning(sprintf(WARNING_CONFIG_FILE_WRITEABLE, dirname($_SERVER['SCRIPT_FILENAME'])));
			}
		}
