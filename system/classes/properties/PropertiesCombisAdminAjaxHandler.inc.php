<?php
/* --------------------------------------------------------------
   PropertiesCombisAdminAjaxHandler.inc.php 2014-11-08 tb@gambio
   Gambio GmbH
   http://www.gambio.de
    ...
    function proceed()
    {
        ...
        switch($t_action_request)
        {
            ...
            case 'save':
                ...
                {
                    case 'combis':
						$t_output_array = $coo_properties_combis_admin_control->save_combis($this->v_data_array['POST'], true, true);
