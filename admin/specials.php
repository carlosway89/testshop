		...
		<tr>
			...
			<td class="boxCenter" width="100%" valign="top">
				<div class="pageHeading"
				     style="background-image:url(images/gm_icons/artkatalog.png)"><?php echo HEADING_TITLE; ?>
				</div>
									...
									<tr class="visibility_switcher">
										...
										<td class="dataTableContent_gm">
											<input type="text"
												   ...
												   value="<?php if ($sInfo->expires_date) echo substr($sInfo->expires_date, 8, 2) . '.' . substr($sInfo->expires_date, 5, 2) . '.' . substr($sInfo->expires_date, 0, 4) ?>"/>
