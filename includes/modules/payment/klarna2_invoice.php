...
class klarna2_invoice_ORIGIN {
	...
	public function selection() {
		...
		if($check['allow_select'] == true) {
			...
			$logo_width = 150;
			$description = '<div style="float:left; margin-right: 1em;">'.$klarna->getCDNTooltip('invoice', $logo_width, $country).'</div>';
			$description .= '<noscript><img style="float: left; margin-right: 1em;" src="'.$klarna->getCDNLogoURL('invoice', $logo_width, $country).'"></noscript>';
