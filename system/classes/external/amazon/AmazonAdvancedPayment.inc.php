<?php
/* --------------------------------------------------------------
	AmazonAdvancedPayment.inc.php 2014-07-21 mabr
	Gambio GmbH
	http://www.gambio.de
...
class AmazonAdvancedPayment
{
	...
	public function get_amazon_address_book_entry($p_customers_id)
	{
		...
		if($t_address_book_id === false)
		{
			...
			$t_ab_data = array(
					...
					'entry_gender' => 'n', // N.B.: Amazon does not record customer's gender!
					'entry_company' => '',
					'entry_firstname' => ' ',
	...
	public function get_button_element()
	{
		...
		$t_element = '<div class="paywithamazonbtn" id="paywithamazonbtn_'.$t_button_number.'" style="'.$t_style.'">';
