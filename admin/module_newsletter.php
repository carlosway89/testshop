<?php
/* --------------------------------------------------------------
   module_newsletter.php 2015-10-19 gm
   Gambio GmbH
   http://www.gambio.de
...
<!-- body_text //-->
    <td class="boxCenter" width="100%" valign="top">
	    ...
	    <div class="pageHeading"
	         style="background-image:url(images/gm_icons/hilfsprogr1.png)"><?php echo HEADING_TITLE; ?></div>
...
?>
        <tr class="dataTableRow">
			...
			<td class="dataTableContent"><a href="<?php echo xtc_href_link(FILENAME_MODULE_NEWSLETTER,'ID='.$news_data[$i]['id']); ?>"><?php echo $news_data[$i]['title']; ?></a></td>
        </tr>
 <?php
