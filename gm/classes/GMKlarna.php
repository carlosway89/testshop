...
EOF;
	...
	public function getWidgetCode($amount, $is_product = false) {
		...
		//$this->_log("getWidgetCode for amount $amount and country $country_id ".($country_active ? 'active' : 'inactive'));
		...
		if($is_product) {
			...
			$widget .= '<img class="klarna_product_logo" src="'.$this->getCDNLogoURL('product', 140).'">';
