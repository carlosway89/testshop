 ...
 * ## Checkbox Widget
 *
 * Toggles the default checkboxes and 2-options radio boxes to a mobile like styling.
 *
			...
			if ($this.find('input:radio').filter(options.filter || '*').length === 2) {
				...
				$switcher
					...
					.append('<div class="switcher-toggler"></div>' + '<div class="switcher-inner">' +
					        ...
					        '><span class="fa fa-times"></span></div>' + '<div class="switcher-text-on">' + options.on_text +
					        '</div>' +
