...
<table border="0" width="100%" cellspacing="2" cellpadding="2">
	<tr>
		...
		<td class="boxCenter" width="100%" valign="top" data-gx-compatibility="dynamic_page_breakpoints" data-dynamic_page_breakpoints-large=".boxCenterWrapper">
			<div class="pageHeading" style="background-image:url(images/gm_icons/gambio.png)">SQL</div>
			<br />
			<span class="main">
				...
				<iframe src="phpminiadmin.php?XSS=<?php echo $_SESSION['XSS']; ?>&page_token=<?php echo $_SESSION['coo_page_token']->generate_token(); ?>" width="100%" height="500" frameborder="0" name="SELFHTML_in_a_box">
