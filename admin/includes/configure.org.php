<?php
/* --------------------------------------------------------------
	configure.org.php 2014-01-14 gm
	Gambio GmbH
	http://www.gambio.de
...
define('HTTP_SERVER', 'http://xa231.13239.whserv.de/'); // eg, http://localhost or - https://localhost should not be empty for productive servers
define('HTTP_CATALOG_SERVER', 'http://xa231.13239.whserv.de/');
define('HTTPS_CATALOG_SERVER', 'https://xa231.13239.whserv.de');
...
define('DB_SERVER_USERNAME', 'xa231_5');
define('DB_SERVER_PASSWORD', '?F.r-.V)|DA$ERL&');
define('DB_DATABASE', 'xa231_db5');
