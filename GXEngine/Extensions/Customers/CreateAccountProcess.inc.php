<?php
/* --------------------------------------------------------------
   CreateAccountProcess.inc.php 2015-08-18 gm
   Gambio GmbH
   http://www.gambio.de
...
include_once DIR_FS_INC . 'xtc_write_user_info.inc.php';
include_once DIR_FS_INC . 'xtc_php_mail.inc.php';
include_once DIR_FS_INC . 'create_coupon_code.inc.php';
include_once DIR_FS_INC . 'xtc_date_raw.inc.php';
...
class CreateAccountProcess extends AbstractCreateAccountProcess
{
	...
	{
		$countryZones = $this->countryService->findCountryZonesByCountryId(MainFactory::create('Id',
	...
	protected function _createAddressBlock()
	{
		if(ACCOUNT_STATE == 'true')
		{
			...
			{
				$countryZone = $this->countryService->getCountryZoneById(MainFactory::create('Id',
		...
		{
			$countryZone = MainFactory::create('CustomerCountryZone', MainFactory::create('Id', 0),
		...
		$addressBlock = MainFactory::create('AddressBlock', MainFactory::create('CustomerGender',
		                                    ...
		                                    $this->countryService->getCountryById(MainFactory::create('Id',
		                                                                                              $this->customerCollection->getValue('country'))),
		                                    $countryZone);
