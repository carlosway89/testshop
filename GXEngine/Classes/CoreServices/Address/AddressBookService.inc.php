<?php
/* --------------------------------------------------------------
   AddressBookService.inc.php 2015-07-06 gm
   Gambio GmbH
   http://www.gambio.de
...
class AddressBookService implements AddressBookServiceInterface
{
	...
	public function createNewAddress(AddressBlockInterface $addressBlock, CustomerInterface $customer)
	{
		...
		$address->setCustomerId(MainFactory::create('Id', $customer->getId()));
	...
	/**
	 * @param IdInterface $addressId
	 *
	 * @return CustomerAddress
	 */
	public function findAddressById(IdInterface $addressId)
	{
