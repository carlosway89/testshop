						...
						array(
							...
							'field'	=> '<div class="newreg_'.$this->pm.'" '.$hasReg.'>					
								<table>
									...
									<tr><td>'.HGW_TXT_CARDBRAND.'*:</td><td><select id="cardBrand" name="ACCOUNT.BRAND">'.$optBrand.'</select></td></tr>
									<tr><td>'.HGW_TXT_CARDNUMBER.'*:</td><td><input type="text" class="text" value="" id="cardNumber" name="ACCOUNT.NUMBER" /></td></tr>
									<tr><td>'.HGW_TXT_CARDHOLDER.'*:</td><td><input type="text" class="text" value="'.$holder.'" id="cardHolder" name="ACCOUNT.HOLDER" /></td></tr>
									<tr><td>'.HGW_TXT_CARDEXPIRY.'*:</td><td><select id="cardExpMonth" name="ACCOUNT.EXPIRY_MONTH">'.$optMonth.'</select><select id="cardExpYear" name="ACCOUNT.EXPIRY_YEAR">'.$optYear.'</select></td></tr>
									<tr><td>'.HGW_TXT_CARDVERI.'*:</td><td><input type="text" class="text" value="" id="cardVerification" name="ACCOUNT.VERIFICATION" /></td></tr>
