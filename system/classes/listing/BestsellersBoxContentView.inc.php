<?php
/* --------------------------------------------------------------
   BestsellersBoxContentView.inc.php 2014-09-09 gambio
   Gambio GmbH
   http://www.gambio.de
...
class BestsellersBoxContentView extends ContentView
{
	...
	{
		$this->add_cache_id_elements(array($this->category_id, $_SESSION['customers_status']['customers_fsk18_display']
									 ));
