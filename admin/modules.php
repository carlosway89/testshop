			...
			while (list($key, $value) = each($_POST['configuration'])) {
				...
				switch($key)
				{
					...
					case 'MODULE_ORDER_TOTAL_COUPON_INC_SHIPPING' :
						xtc_db_query("update " . TABLE_CONFIGURATION . " set configuration_value = '" . $value . "' where configuration_key IN ('MODULE_ORDER_TOTAL_GV_INC_SHIPPING', 'MODULE_ORDER_TOTAL_COUPON_INC_SHIPPING')");
						break;
				}
