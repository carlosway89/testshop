				...
				<td  class="boxCenter" width="100%" valign="top">
						...
						switch($_POST['action']) {
							case 'edit':
								...
								echo '<div class="pageHeading" style="background-image:url(images/gm_icons/artkatalog.png)">' . TITLE_EDIT.': ' . xtc_findTitle((int)$_POST['current_product_id'], $languageFilter) . '</div>';
								...
								break;
							case 'change':
								echo '<div class="pageHeading" style="background-image:url(images/gm_icons/artkatalog.png)">' . TITLE_UPDATED . '</div>';
								include(DIR_WS_MODULES . 'new_attributes_change.php');
								...
								break;
							default:
								echo '<div class="pageHeading" style="background-image:url(images/gm_icons/artkatalog.png)">' . TITLE_EDIT . '</div>';
								echo '<form action="' . xtc_href_link('new_attributes.php') . '" name="SELECT_PRODUCT" method="post">';
