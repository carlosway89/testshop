<?php
/* --------------------------------------------------------------
   categories_view.php 2015-10-22 gm
   Gambio GmbH
   http://www.gambio.de
...
$productBtnConfigValue = $userConfigurationService->getUserConfiguration($userId, 'productOverviewDropdownBtn');
$categoryBtnConfigValue = $userConfigurationService->getUserConfiguration($userId, 'categoryOverviewDropdownBtn');
$multiBtnConfigValue = $userConfigurationService->getUserConfiguration($userId, 'multiCategoryOverviewDropdownBtn');
...
<table width="100%" cellspacing="0" cellpadding="0" class="gx-categories breakpoint-large"
       ...
       data-button_dropdown-config_keys="categoryOverviewDropdownBtn productOverviewDropdownBtn multiCategoryOverviewDropdownBtn"
>
    <tr>
     <td>
...
// ----------------------------------------------------------------------------------------------------- //
    ...
    >
      ...
      <td class="categories_view_data" style="text-align: left; padding-left: 8px;">
        <?php echo
		        '<a href="'.xtc_href_link(FILENAME_CATEGORIES, xtc_get_all_get_params(array('cPath', 'action', 'pID', 'cID')) . 'cPath=' . $cPath . '&pID=' . $products['products_id']) . '&action=new_product">' . $products['products_name'] . '</a>';?>
      </td>
