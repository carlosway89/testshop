<?php
/* --------------------------------------------------------------
   WithdrawalModel.inc.php 2014-07-14 tb@gambio
   Gambio GmbH
   http://www.gambio.de
...
class WithdrawalModel
{
	...
	public function save()
	{
		...
		else
		{
			...
			$t_withdrawal_id = mysql_insert_id();
		}
	...
	public function set_order_date($p_order_date)
	{
		...
		if($p_order_date == '0000-00-00 00:00:00')
		{
	...
	public function set_delivery_date($p_delivery_date)
	{
		...
		if($p_delivery_date == '0000-00-00 00:00:00')
		{
	...
	public function set_withdrawal_date($p_withdrawal_date)
	{
		...
		if($p_withdrawal_date == '0000-00-00 00:00:00')
		{
	...
	public function set_date_created($p_date_created)
	{
		...
		if($p_date_created == '0000-00-00 00:00:00')
		{
