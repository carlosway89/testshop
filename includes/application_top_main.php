<?php
/* --------------------------------------------------------------
   application_top_js.php 2015-12-29 gm
   Gambio GmbH
   http://www.gambio.de
...
{
	throw new Exception('Vendor directory is missing from the filesystem. Please install the PHP dependencies by '
...
session_name('XTCsid');
if (STORE_SESSIONS != 'mysql') session_save_path(DIR_FS_CATALOG . 'cache/');
...
if( file_exists( DIR_FS_CATALOG . 'system/classes/mobile/MobileControl.inc.php' ) )
{
