...
<html xmlns="http://www.w3.org/1999/xhtml" <?php echo HTML_PARAMS; ?>>
	...
	<body marginwidth="0" marginheight="0" topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0" bgcolor="#FFFFFF">
		...
		<script type="text/javascript" src="<?php echo DIR_WS_CATALOG; ?>gm_javascript.js.php?page=Section&section=load_gprint&globals=off&mode=backend&XTCsid=<?php echo xtc_session_id(); ?>&languages_id=<?php echo (int)$_GET['languages_id']; ?>&id=<?php echo (int)$_GET['id']; ?>"></script>
