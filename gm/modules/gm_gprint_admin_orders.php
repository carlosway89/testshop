...
for($m = 0; $m < count($coo_gm_gprint_order_data); $m++)
{
	...
	{
		echo '- ' . $coo_gm_gprint_order_data[$m]['NAME'] . ': <a href="' . xtc_href_link('request_port.php', 'module=GPrintDownload&key=' . $coo_gm_gprint_order_data[$m]['DOWNLOAD_KEY']) . '">' . $coo_gm_gprint_order_data[$m]['VALUE'] . '</a><br />';
	}
}
