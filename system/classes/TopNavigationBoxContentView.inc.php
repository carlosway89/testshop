<?php
/* --------------------------------------------------------------
  TopNavigationBoxContentView.inc.php 2015-10-26
  Gambio GmbH
  http://www.gambio.de
...
/*
	protected function _setCustomersDataName()
	{
		$this->content_array['customers_data']['FIRST_NAME'] = '';
		if(isset($_SESSION['customer_first_name']))
		{
			$this->content_array['customers_data']['FIRST_NAME'] = $_SESSION['customer_first_name'];
		}

		$this->content_array['customers_data']['LAST_NAME'] = '';
		if(isset($_SESSION['customer_last_name']))
		{
			$this->content_array['customers_data']['LAST_NAME'] = $_SESSION['customer_last_name'];
		}
	}
*/
	...
	protected function _setCustomersDataIcon()
	{
		...
		{
			$this->customersDataArray['ICON'] = 'admin/images/icons/' . basename($_SESSION['customers_status']['customers_status_image']);
		}
	}
