<?php
/* --------------------------------------------------------------
   AttachmentsApiV2Controller.inc.php 2015-07-22 gm
   Gambio GmbH
   http://www.gambio.de
...
class AttachmentsApiV2Controller extends HttpApiV2Controller
{
	 ...
	 *
	 * @apiDescription
	 * If an email contains an attachment then this must be uploaded before the email is sent. This
	...
	public function post()
	{
		...
		$file = $this->attachmentsHandler->uploadAttachment(array_shift($_FILES));
