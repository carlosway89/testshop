...
gx.extensions.module(
	...
	/** @lends module:Extensions/table_inline_edit */
	...
	function (data) {
		...
		var _createNewLine = function () {
			...
			jse.core.fallback.setupWidgetAttr($newLine);
		...
		var _deleteHandler = function () {
			var $self = $(this),
				...
				url = $self.data().url,
				lightboxLink = $(
					'<a href="lightbox_confirm.html?section=shop_offline&amp;message=delete_job&amp;buttons=cancel-delete"></a>'
				),
				lightboxId = lightboxLink.lightbox_plugin({
					                                          'lightbox_width': '360px'
				                                          });
