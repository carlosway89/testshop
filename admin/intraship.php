								...
								<form action="<?php echo PAGE_URL ?>" method="POST" class="bluegray">
									<fieldset class="left">
										...
										<dl class="adminform">
											...
											<dt>##use_postfinder</dt>
											<dd>
												<input type="radio" name="intraship[use_postfinder]" value="1" id="intraship_use_postfinder_yes" <?php echo $intraship->use_postfinder == '1' ? 'checked="checked"' : '' ?>>
												<label for="intraship_use_postfinder_yes">##yes</label><br>
												<input type="radio" name="intraship[use_postfinder]" value="0" id="intraship_use_postfinder_no" <?php echo $intraship->use_postfinder == '0' ? 'checked="checked"' : '' ?>>
												<label for="intraship_use_postfinder_no">##no</label><br>
											</dd>
										</dl>
									</fieldset>
