...
*/
	...
	$identTransId = mysql_real_escape_string(htmlspecialchars((string)$xml->Transaction->Identification->TransactionID));
	$crit_Secret = mysql_real_escape_string(htmlspecialchars((string)$xml->Transaction->Analysis->SECRET));
	...
	$orderId = mysql_real_escape_string(htmlspecialchars((string)$xml->Transaction->Identification->TransactionID));
	...
	$processingCode = mysql_real_escape_string((string)$xml->Transaction->Processing['code']);
	...
	}elseif($processingResult == 'NOK' && $orderStatus != (int)$statusCanceled && $orderStatus != (int)$statusProcessed) {
