...
INSERT INTO `gm_configuration` SET `gm_key` = 'GM_FOOTER', `gm_value` = '';
...
INSERT INTO `gm_configuration` SET `gm_key` = 'GM_GPRINT_POSITION', `gm_value` = '3';
...
INSERT INTO `gm_configuration` SET `gm_key` = 'GM_PDF_ALLOW_PRINTING', `gm_value` = '1';
