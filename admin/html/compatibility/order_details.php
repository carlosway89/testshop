 ...
 */
$bankTransferQuery = xtc_db_query('select banktransfer_prz, banktransfer_status, banktransfer_owner, banktransfer_number, banktransfer_bankname, banktransfer_blz, banktransfer_fax from banktransfer where orders_id = "'
...
<div class="gx-container order-details"
	...
	<div class="head grid breakpoint-large">
		<div class="span2-odd head-item">
			...
			<div class="simple-container">
				...
				<label class="value"> <?php echo $GLOBALS['oID'] ?> </label>
			</div>
		</div>
		...
		<div class="span2-odd head-item">
			...
			<div class="simple-container">
				<i class="fa fa-eur"></i>
				<label class="value"> <?php echo $GLOBALS['order']->totals[count($GLOBALS['order']->totals)
				                                                           - 1]['text'] ?> </label>
			</div>
		</div>
		...
		<div class="span2-odd head-item">
			...
			<div class="simple-container">
				<label class="value" title="<?php if(!empty($GLOBALS['order']->info['payment_method']))
				{
					echo $GLOBALS['order']->info['payment_method'];
				} ?>"> <?php if(!empty($GLOBALS['order']->info['payment_method']))
					{
	...
	<div class="content article-table grid breakpoint-large">
			...
			<div class="frame-wrapper">
				<div class="frame-head">
					...
					<label class="pull-right head-link default">
						<a href="<?php echo xtc_href_link(FILENAME_ORDERS_EDIT,
						                                  'edit_action=products&oID=' . (int)$GLOBALS['oID']) ?>">
				...
				<div class="frame-content">
					<table id="order-details-table">
						...
						<tbody>
								...
								<tr>
									...
									<td>
										<div class="grid">
											<div class="span12">
												<?php
												echo '<div class="products-name">' . $productInformation['name']
												     . '</div>';
												...
												if(sizeof($productInformation['attributes']) > 0)
												{
													...
													for($j = 0, $k = sizeof($productInformation['attributes']); $j
													                                                            < $k; $j++)
													{
														if(!empty($productInformation['attributes'][$j]['option'])
														   || !empty($productInformation['attributes'][$j]['value'])
														)
														{
															echo '- ' . $productInformation['attributes'][$j]['option']
												...
												if(count($productInformation['properties']) > 0)
												{
													...
													for($j = 0, $k = sizeof($productInformation['properties']); $j
													                                                            < $k; $j++)
													{
														if(!empty($productInformation['properties'][$j]['properties_name'])
														   || !empty($productInformation['properties'][$j]['values_name'])
														)
														{
															echo '- '
															     . $productInformation['properties'][$j]['properties_name']
															     . ': '
															     . $productInformation['properties'][$j]['values_name']
															     . '<br/>';
														}
													}
													echo '</div>';
									...
									<td class="text-right">
										<div class="grid">
											<div class="span12">
												<?php
												$modelArray = ($productInformation['model']
												...
												if(null !== $productInformation['attributes'])
												{
													...
													{
														$model        = xtc_get_attributes_model($productInformation['id'],
							...
							<?php endforeach; ?>
							<tr id="order-sum-row">
								<td colspan="<?php if($productInformation['allow_tax'])
								{ ?>6<?php }
								else
								{ ?>4<?php } ?>" class="text-right">
									<div class="grid">
										<?php
										$counter          = 0;
	...
	<!--
		AMAZON PAYMENT
	-->
	<div class="content article-table grid breakpoint-large hidden">
		<div class="span12 remove-padding">
			<div class="frame-wrapper">
				<div class="frame-head">
					<label class="title">
	...
	<div class="content grid breakpoint-large">
		<div class="span6">
			<!--
				ORDER INFO BOX
			-->
			<div class="frame-wrapper">
				<div class="frame-head">
					...
					<label class="pull-right head-link default">
						<a href="<?php echo xtc_href_link(FILENAME_ORDERS_EDIT,
						                                  'edit_action=address&oID=' . (int)$GLOBALS['oID']) ?>">
							<?php echo BUTTON_EDIT ?>
						</a>
					</label>
				</div>
				<div class="frame-content simple-container">
					<div class="span6">
						...
						<div class="content">
							<span><?php echo $GLOBALS['order']->billing['name'] ?></span>
							<br />
							<?php if($GLOBALS['order']->billing['company'] !== ''): ?>
								<span><?php echo $GLOBALS['order']->billing['company']; ?></span>
								<br />
							<?php endif; ?>
							<span><?php echo $GLOBALS['order']->billing['street_address'] ?></span>
							<br />
							<span><?php echo $GLOBALS['order']->billing['postcode'] . ' '
							                 . $GLOBALS['order']->billing['city'] ?></span>
							<br />
					...
					<div class="span6">
						...
						<div class="content">
							<span><?php echo $GLOBALS['order']->delivery['name'] ?></span>
							<br />
							<?php if($GLOBALS['order']->delivery['company'] !== ''): ?>
								<span><?php echo $GLOBALS['order']->delivery['company']; ?></span>
								<br />
							<?php endif; ?>
							<span><?php echo $GLOBALS['order']->delivery['street_address'] ?></span>
							<br />
							<span><?php echo $GLOBALS['order']->delivery['postcode'] . ' '
							                 . $GLOBALS['order']->delivery['city'] ?></span>
							<br />
			...
			<div id="tracking_code_wrapper" class="frame-wrapper">
				...
				<div class="frame-content gx-container table-content"
				     ...
				     data-gx-controller="order/order_parcel_tracking"
				     data-order_parcel_tracking-container="tracking_code_wrapper">
					<?php
									...
									<tr>
										...
										<td class="text-center">
											<?php echo ($orderStatusRow['customer_notified']
											            == '1') ? '<i class="fa fa-check fa-lg"></i>' : '<i class="fa fa-times fa-lg"></i>'; ?>
										</td>
										<td>
...
-->
		...
		<div class="span6 remove-padding">
			...
			<div class="frame-wrapper info customers">
				<div class="frame-head info">
					...
					<label class="pull-right head-link">
						<a href="<?php echo xtc_href_link('customers.php', 'cID=' . $GLOBALS['order']->customer['ID']
						                                                   . '&action=edit'); ?>">
				...
				<div class="frame-content simple-container">
					<div class="grid">
						...
						<div class="span6">
							<span><?php echo $GLOBALS['order']->customer['name']; ?></span>
							<br />
							<?php if($GLOBALS['order']->customer['company'] !== ''): ?>
								<span><?php echo $GLOBALS['order']->customer['company']; ?></span>
								<br />
							<?php endif; ?>
							<span><?php echo $GLOBALS['order']->customer['street_address']; ?></span>
							<br />
							<span><?php echo $GLOBALS['order']->customer['postcode'] . ' '
							                 . $GLOBALS['order']->customer['city']; ?></span>
							<br />
					...
					<div class="grid">
						<div class="span6">
							...
							<?php if($GLOBALS['order']->customer['vat_id'] !== ''): ?>
								<label><?php echo str_replace(':', '', ENTRY_CUSTOMERS_VAT_ID); ?></label>
								<br />
							<?php endif; ?>
							<label><?php echo str_replace(':', '', ENTRY_TELEPHONE); ?></label>
							<br />
							<label><?php echo str_replace(':', '', ENTRY_CUSTOMERS_GROUP); ?></label>
							<br />
							<label><?php echo str_replace(':', '', TITLE_CUSTOMER_ID); ?></label>
							<br />
							<label><?php echo str_replace(':', '', ENTRY_LANGUAGE); ?></label>
						</div>
						<div class="span6">
							<span>
								<a href="admin.php?do=Emails&mailto=<?php echo $GLOBALS['order']->customer['email_address']; ?>">
							...
							<br />
							<?php if($GLOBALS['order']->customer['vat_id'] !== ''): ?>
								<span><?php echo $GLOBALS['order']->customer['vat_id']; ?></span>
								<br />
							<?php endif; ?>
							<span><?php echo $GLOBALS['order']->customer['telephone']; ?></span>
							<br />
							<span><?php echo $GLOBALS['order']->info['status_name']; ?></span>
							<br />
							<span>
								<?php
					...
					<div class="grid">
						<div class="span6">
							<label><?php echo ENTRY_FIRST_ORDER; ?></label>
							<br />
							<label><?php echo ENTRY_LAST_ORDER; ?></label>
							<br />
							<label><?php echo ENTRY_ORDER_TOTAL; ?></label>
							<br />
							<label><?php echo ENTRY_ORDER_SUM_TOTAL; ?></label>
						</div>
						<div class="span6">
							<span><?php echo $firstOrderDate; ?></span>
							<br />
							<span><?php echo $lastOrderDate; ?></span>
							<br />
							<span class="amount">
				...
				<div class="frame-content table-content customer-memos">
					<table>
						<thead>
							<tr>
								<th colspan="3">
									<?php echo $GLOBALS['coo_lang_file_master']->get_text('ENTRY_COMMENTS',
									                                                      'admin_customers') ?>
								</th>
							</tr>
						</thead>
							...
							<tr>
								...
								<td valign="top">
									<div class="block pull-right">
										<span class="date"><?php echo date('d. F Y',
										                                   strtotime($row['memo_date'])) ?></span>
                                                <span class="poster">
                                                    <?php
			...
			<div class="frame-wrapper withdrawals  <?php if(count($withdrawalsDataArray) > 0): ?>danger<?php endif; ?>">
				<div class="frame-head <?php if(count($withdrawalsDataArray) > 0): ?>danger<?php endif; ?>">
					...
					<label class="pull-right head-link">
						<a href="<?php echo gm_xtc_href_link('withdrawal.php', 'order_id=' . $GLOBALS['oID']); ?>"
						   target="_blank">
						...
						<table>
							...
							<tbody>
								<?php foreach($withdrawalsDataArray as $withdrawalsData): ?>
									<tr>
										<td>
											<a href="<?php echo xtc_href_link('withdrawals.php',
			...
			<div class="frame-wrapper invoices">
				<div class="frame-head">
					...
					<?php if(gm_pdf_is_installed()): ?>
						<label class="pull-right head-link default">
							<a onclick="window.open('<?php echo xtc_href_link('gm_pdf_order.php',
							                                                  'oID=' . (int)$GLOBALS['oID']
							                                                  . '&type=invoice'); ?>', '_blank')">
			...
			<div class="frame-wrapper packingslips">
				...
				<div class="frame-content">
					<table>
						<tbody>
							<tr>
								<td class="packingslip-content"
								    colspan="2"
								    data-gx-compatibility="orders/order_packingslip">
	...
	-->
	<div class="order-footer breakpoint-large">
		<div class="grid">
			<div class="span12 remove-padding">
				<hr>
			</div>
		...
		<div class="grid">
			<div class="span12 text-right remove-padding">
				<button type="button" class="btn"
				        onclick="window.location.href = '<?php echo xtc_href_link(FILENAME_ORDERS,
