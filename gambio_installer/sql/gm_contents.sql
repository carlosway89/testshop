...
INSERT INTO `gm_contents` SET `gm_key` = 'GM_PDF_EMAIL_TEXT', `languages_id` = 1, `gm_value` = '', `gm_group_id` = 0;
INSERT INTO `gm_contents` SET `gm_key` = 'GM_PDF_EMAIL_TEXT', `languages_id` = 2, `gm_value` = 'Sehr {SALUTATION} {CUSTOMER},\n\nSie erhalten mit dieser E-Mail Ihre Rechnung Nr. {INVOICE_ID} von der Bestellung Nr. {ORDER_ID} vom {DATE}.\n\nMit freundlichem Gruß\n\nIhr Ansprechpartner', `gm_group_id` = 0;
...
INSERT INTO `gm_contents` SET `gm_key` = 'XTCsid', `languages_id` = 2, `gm_value` = 'b391baf59be7494b871846d2d5bf7a45', `gm_group_id` = 0;
