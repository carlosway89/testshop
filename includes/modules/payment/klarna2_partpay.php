...
class klarna2_partpay_ORIGIN {
	...
	public function selection() {
		...
		if($check['allow_select'] == true && $pclasses !== false) {
			...
			$logo_width = 150;
			$description = '<div style="float:left; margin-right: 1em;">'.$klarna->getCDNTooltip('account', $logo_width, $country).'</div>';
			$description .= '<noscript><img style="float: left; margin-right: 1em;" src="'.$klarna->getCDNLogoURL('account', $logo_width, $country).'"></noscript>';
