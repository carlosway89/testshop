...
class PayPalConfigurationController extends AdminHttpViewController
{
	...
	*/
	...
	public function actionDefault()
	{
		...
		{
			return new RedirectHttpControllerResponse(xtc_href_link('admin.php', 'do=PayPalConfiguration/FirstTime'));
		}
		...
		return new AdminPageHttpControllerResponse($this->paypalText->get_text('paypal_configuration'), $html);
	}
	...
	public function actionFirstTime()
	{
		...
		$create_webhook = ENABLE_SSL_CATALOG === 'true';
		...
		$html = $this->paypalText->replaceLanguagePlaceholders($html);
		return new AdminPageHttpControllerResponse($this->paypalText->get_text('paypal_configuration_first'), $html);
	}
	...
	public function actionSaveFirstConfiguration()
	{
		...
		return new RedirectHttpControllerResponse(xtc_href_link('admin.php', 'do=PayPalConfiguration'));
	}
	...
	public function actionSaveConfiguration()
	{
		...
		return new RedirectHttpControllerResponse('./admin.php?do=PayPalConfiguration');
	}
	...
	public function actionSaveExperienceProfile()
	{
		...
		return new RedirectHttpControllerResponse($redirect_url);
	}
	...
	public function actionConnectCheck()
	{
		...
		{
			return new HttpControllerResponse('invalid URL');
		}
		...
		return new HttpControllerResponse($response);
	}
