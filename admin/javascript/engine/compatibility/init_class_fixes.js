/* --------------------------------------------------------------
 init_class_fixes.js 2015-10-16 gm
 Gambio GmbH
 http://www.gambio.de
...
gx.compatibility.module(
	...
	function (data) {
						        ...
						        'buttons': [
							        ...
							        },
							        {
								        ...
								        'click': function () {
									        $.ajax({
										               url: [
											               (window.location.origin + window.location.pathname.replace('customers.php',
											                                                                          '')),
											               'request_port.php',
		 ...
		 */
		fixes.push(function () {
			var urlHelper = window.gx.libs.url_arguments, // alias
				$form = $('form[name="customers"]');

			if (urlHelper.getCurrentFile() === 'customers.php' && urlHelper.getParameterArray().action ===
			                                                      'editstatus') {
