...
define('BUTTON_CONFIGURE', 'Updates-Configuration');
define('BUTTON_SHOW_UPDATES', 'Updates-Overview');
...
define('DESCRIPTION_FORCE_VERSION_SELECTION', 'If the update process was either canceled or failed for any reason, the current version can be selected through this option, to execute the update again.');
