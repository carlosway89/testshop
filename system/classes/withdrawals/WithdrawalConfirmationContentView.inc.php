<?php
/* --------------------------------------------------------------
  WithdrawalConfirmationContentView.inc.php 2014-11-03 gm
  Gambio GmbH
  http://www.gambio.de
...
class WithdrawalConfirmationContentView extends ContentView
{
	...
	public function get_html($p_type, $p_languages_id, $p_language, $p_filename = 'withdrawal_confirmation', $p_folder = '')
	{
		$this->prepare_data();
		$t_output = fetch_email_template($this, $p_filename, $p_type, $p_folder, $p_languages_id, $p_language);
