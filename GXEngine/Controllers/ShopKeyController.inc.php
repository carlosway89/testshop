<?php
/* --------------------------------------------------------------
   ShopKeyController.inc.php 2015-09-11
   Gambio GmbH
   http://www.gambio.de
...
class ShopKeyController extends AdminHttpViewController
{
	...
	public function actionDefault()
	{
		...
		return new AdminPageHttpControllerResponse($pageTitle, $html, null, array('shop_key'));
	}
	...
	{
		$this->_store($this->_getPostData('GAMBIO_SHOP_KEY'));
