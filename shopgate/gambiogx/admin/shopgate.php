        ...
        <td class="shopgate_setting" align="right">
            <table width="100%" cellspacing="0" cellpadding="4" border="0"
                ...
                <tr>
                    ...
                    <td class="<?php echo $tableClass; ?> shopgate_input">
                        <div>
                            <textarea name="_shopgate_config[export_option_as_input_field]" id="sg_export_option_as_input_field"><?php echo $shopgateConfig["export_option_as_input_field"] ?></textarea>
                        </div>
