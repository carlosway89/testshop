<?php
/* --------------------------------------------------------------
   ProductMediaContentView.inc.php 2015-05-29 gm
   Gambio GmbH
   http://www.gambio.de
...
// ########## PROTECTED / PRIVATE METHODS ##########
	...
	protected function _generateIconUrls(array $contentArray)
	{
		...
		{
			$resultArray['icon'] = xtc_image(DIR_WS_CATALOG . 'admin/images/icons/icon_link.gif');
			$resultArray['iconUrl'] = DIR_WS_CATALOG . 'admin/images/icons/icon_link.gif';
		}
		else
		{
			$file = str_replace('.', '', strstr($contentArray['content_file'], '.'));
			$resultArray['icon'] = xtc_image(DIR_WS_CATALOG . 'admin/images/icons/icon_' . $file . '.gif');
			$resultArray['iconUrl'] = DIR_WS_CATALOG . 'admin/images/icons/icon_' . $file . '.gif';
		}
