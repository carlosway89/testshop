<?php
/* --------------------------------------------------------------
   GMIPayment.php 2015-05-20 mabr
   Gambio GmbH
   http://www.gambio.de
...
class GMIPayment_ORIGIN {
	...
	public function __construct($code) {
		...
		//$this->_target_url = 'https://ipayment.de/merchant/'.$this->_pm_config['ACCOUNT_ID'].'/example/2.0/';
		//$this->_target_url = 'https://ipayment.de/merchant/'.$this->_pm_config['ACCOUNT_ID'].'/processor.php';
	}
