...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Installation Gambio GX2</title>
	...
	<body>
		...
		<div id="main" class="gradient">
			...
			?>
				...
				<?php
					...
					echo xtc_draw_hidden_field_installer('STORE_SESSIONS', 'files');
		...
		<div id="copyright">
			<strong><a href="http://www.gambio.de" target="_blank"><strong>Gambio.de</strong></a> - Installer &copy; 2016 Gambio GmbH</strong><br />
