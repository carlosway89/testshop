...
class EmailWriter implements EmailWriterInterface
{
	...
	/**
	 * Insert an email record to the database.
	 *
	 * @param EmailInterface $email
	 */
	protected function _insert(EmailInterface $email)
	{
		...
		$email->setId(MainFactory::create('Id', $this->db->insert_id()));
	}


	/**
	 * Update an email record from the database.
	 *
	 * @param EmailInterface $email
	 */
	...
	/**
	 * Write Email Contacts and Attachments.
	 *
