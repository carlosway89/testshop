	...
	if($_GET['type'] == 'order') {
		...
		if ($check_status['orders_status'] != $gm_status) {
			...
			if($_GET['gm_notify'] == 'on') {
				...
				xtc_php_mail(EMAIL_BILLING_ADDRESS, EMAIL_BILLING_NAME, $check_status['customers_email_address'], $check_status['customers_name'], '', EMAIL_BILLING_REPLY_ADDRESS, EMAIL_BILLING_REPLY_ADDRESS_NAME, '', '', $subject, $html_mail, $txt_mail);
