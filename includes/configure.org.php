...
define('HTTP_SERVER', 'http://xa231.13239.whserv.de/'); // eg, http://localhost - should not be empty for productive servers
define('HTTPS_SERVER', 'https://xa231.13239.whserv.de'); // eg, https://localhost - should not be empty for productive servers
