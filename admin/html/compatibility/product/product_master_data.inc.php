<?php
/* --------------------------------------------------------------
   product_master_data.php 2015-08-28
   Gambio GmbH
   http://www.gambio.de
...
<div class="span6">
	...
	<?php if(ACTIVATE_SHIPPING_STATUS == 'true'): ?>
		<div class="grid control-group">
			...
			<div class="span6">
				<?php echo xtc_draw_pull_down_menu('shipping_status', $shippingStatuses,
					$pInfo->products_shippingtime); ?>
			</div>
		</div>
	<?php endif; ?>
	...
	<div class="grid control-group">
		...
		<div class="span6">
			<input type="text"
				...
				value="<?php echo $pInfo->products_date_available; ?>"
			/>
		</div>
	</div>
	<div class="grid control-group">
