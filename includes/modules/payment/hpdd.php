			...
			if(isset($getFormUrl)){
				if($getFormUrl['PROCESSING.RESULT'] == 'NOK'){
							...
							array(
								...
								document.addEventListener('DOMContentLoaded', function(){
									jQuery(document).ready(function(){
										...
										var accBic 		= jQuery(\".newreg_".$this->pm." input[name='ACCOUNT.BIC']\");
					...
					if(($sepamode == 1) || ($sepamode == 2)){
						...
						$bankdata .= '<tr><td>'.HGW_TXT_ACC_BIC.'*:</td><td><input type="text" class="text " value="" id="bic" name="ACCOUNT.BIC" /></td></tr>';
					}
