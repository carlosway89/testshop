<?php
/* --------------------------------------------------------------
   SendOrderProcess.inc.php 2015-04-15 gm
   Gambio GmbH
   http://www.gambio.de
...
class SendOrderProcess extends DataProcessing
{
	...
	public function proceed()
	{
		...
		{
			$t_janolaw_info_html  = $coo_janolaw->get_page_content('widerrufsbelehrung', true, true);
			$t_janolaw_info_html .= '<br/><br/>AGB<br/><br/>';
			$t_janolaw_info_html .= $coo_janolaw->get_page_content('agb', true, true);

			$t_janolaw_info_text  = $coo_janolaw->get_page_content('widerrufsbelehrung', false, false);
			$t_janolaw_info_text .= "\n\nAGB\n\n";
			$t_janolaw_info_text .= $coo_janolaw->get_page_content('agb', false, false);
		}
		# JANOLAW END
