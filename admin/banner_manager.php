<?php
/* --------------------------------------------------------------
   banner_manager.php 2015-09-28 gm
   Gambio GmbH
   http://www.gambio.de
...
?>
                <td class="dataTableContent" style="cursor: pointer;"><?php echo '<a href="javascript:popupImageWindow(\'' . FILENAME_POPUP_IMAGE . '?banner=' . $banners['banners_id'] . '\')">' . xtc_image(DIR_WS_IMAGES . 'icon_popup.gif', 'View Banner') . '</a>&nbsp;' . $banners['banners_title']; ?></td>
