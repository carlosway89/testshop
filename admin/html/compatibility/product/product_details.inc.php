<?php
/* --------------------------------------------------------------
   product_details.inc.php 2015-08-28
   Gambio GmbH
   http://www.gambio.de
...
<div class="span6">
	...
	<div class="grid control-group">
		...
		<div class="span6">
			<?php echo xtc_draw_input_field('products_meta_description[' . $language['id'] . ']',
				(($products_meta_description[$language['id']]) ? stripslashes($products_meta_description[$language['id']]) : xtc_get_products_meta_description($pInfo->products_id,
				                                                                                                                                               $language['id']))); ?>
		</div>
	</div>
	<div class="grid control-group remove-border">
