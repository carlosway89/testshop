<?php
/* --------------------------------------------------------------
   CartShippingCostsControl.inc.php 2014-11-14 gm
   Gambio GmbH
   http://www.gambio.de
...
class CartShippingCostsControl
{
	 ...
	 */
	public function get_shipping_costs($p_shipping_country = false, $p_shipping_module = false, $p_shipping_method = '')
	{	
		...
		if ($p_shipping_module == 'free')
		{
			...
			return $t_formatted_shipping_costs;
		}
