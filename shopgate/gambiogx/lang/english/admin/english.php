...
define('SHOPGATE_CONFIG_EXPORT_OPTIONS_AS_INPUT_FIELD_DESCRIPTION', 'Add the option id (can be found in "Product Options") which needs to be exported as text field to the text area.(example: 1,2,3). Information: no comma at the end.');
