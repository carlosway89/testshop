...
class CustomerFirstname implements CustomerFirstnameInterface
{
	 ...
	 * @throws LengthException if trim($p_firstname) contains more characters than allowed. Maximal allowed characters: VARCHAR(32)
	 */
	public function __construct($p_firstname)
	{
		...
		{
			throw new LengthException('$firstname is longer than ' . $dbFieldLength . ' characters VARCHAR(32)');
		}
