<?php
/* --------------------------------------------------------------
   SplitNavigationContentView.inc.php 2014-02-25 misc
   Gambio GmbH
   http://www.gambio.de
...
class SplitNavigationContentView extends ContentView
{
	...
	public function prepare_data()
	{
		...
		if(empty($t_uninitialized_array))
		{
			...
			$this->content_array['RIGHT'] = TEXT_RESULT_PAGE.' '.$this->coo_split_page_results->display_links(MAX_DISPLAY_PAGE_LINKS, xtc_get_all_get_params(array ('page', 'info', 'x', 'y')));
		}
		else
		{
