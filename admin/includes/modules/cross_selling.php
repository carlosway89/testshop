...
?>
    <table width="100%" cellspacing="0" cellpadding="2" data-gx-widget="checkbox" class="gx-container" style="margin-bottom: 24px">
      <tr>
        <td>
...
?>
  ...
  <tr class="dataTableRow row_selection">
    <td class="dataTableContent categories_view_data"><input type="checkbox" name="ids[]" value="<?php echo $cross_data['ID']; ?>" data-single_checkbox></td>
...
?>
              <tr class="dataTableRow row_selection">
                <td class="dataTableContent categories_view_data"><input type="checkbox" name="ids[]" value="<?php echo $data['products_id']; ?>" data-single_checkbox></td>
...
?>
  <tr class="dataTableRow row_selection">
    <td class="dataTableContent categories_view_data"><input type="checkbox" name="ids[]" value="<?php echo $search_data['products_id']; ?>" data-single_checkbox></td>
