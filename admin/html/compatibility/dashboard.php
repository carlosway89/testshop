...
<div class="dashboard-wrapper"  
	 ...
	 data-dashboard_controller-collapsed="<?php echo $userConfigurationService->getUserConfiguration($userId,
		 'dashboard_chart_collapse'); ?>">
	<!-- Statistics boxes -->
	<div class="gx-container" data-gx-extension='toolbar_icons'>
		<div id="statistic-grid">
