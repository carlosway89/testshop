...
?>
	...
	<div class="main-bottom-footer"
	     data-gx-compatibility="sticky_footer">
			...
			<tr>
				<td align="center">
					...
					<?php
						...
						*/
					?>
					<strong><a href="http://www.gambio.de" target="_blank"><strong>Gambio.de</strong></a> - Administrationsbereich &copy; 
					2016 Gambio GmbH</strong> Gambio GmbH provides no warranty. The Shopsoftware is redistributable under the 
