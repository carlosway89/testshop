<?php
/* --------------------------------------------------------------
   WishListContentView.inc.php 2015-10-20
   Gambio GmbH
   http://www.gambio.de
...
class WishListContentView extends ContentView
{
	...
	{
		# order details
		/** @var OrderDetailsWishListContentView $coo_order_details_wish_list */
		$coo_order_details_wish_list = MainFactory::create_object('OrderDetailsWishListContentView');

		$coo_order_details_wish_list->setProductsArray($this->products);
		$t_view_html = $coo_order_details_wish_list->prepare_data();
